                ...
                <div class="card-header py-3">
                  <div class="row">
                    <div class="col-6 float-left">
                      <h6 class="mt-1 font-weight-bold text-primary">Antrian Poli Spesialis Jantung</h6>
                    </div>
                ...
                <div class="card-body">
                  ...
                  <div class="jumbotron">
                    ...
                    <h1 class="display-3 text-center" id="nomor-antrian">
                      <?php
                      $qAntrian = mysqli_query($conn, "SELECT * FROM a_antrian WHERE nm_poli = 'Poli Spesialis Jantung' AND status != 'selesai'");

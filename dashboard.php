...
<body id="page-top">
    ...
    <script>
        ...
        window.setInterval(function() {
            $("#poli1").load("pages/trigger/dashboard/poli1.php");
        }, 1000);
        

        window.setInterval(function() {
            $("#poli2").load("pages/trigger/dashboard/poli2.php");
        }, 1000);
        

        window.setInterval(function() {
            $("#poli3").load("pages/trigger/dashboard/poli3.php");
        }, 1000);
        

        window.setInterval(function() {
            $("#poli4").load("pages/trigger/dashboard/poli4.php");
        }, 1000);
        

        window.setInterval(function() {
            $("#poli5").load("pages/trigger/dashboard/poli5.php");
        }, 1000);
        

        window.setInterval(function() {
            $("#poli6").load("pages/trigger/dashboard/poli6.php");
        }, 1000);
        

        window.setInterval(function() {
            $("#poli7").load("pages/trigger/dashboard/poli7.php");
        }, 1000);
